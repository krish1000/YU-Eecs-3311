...
void A159_162 (EIF_REFERENCE Current, EIF_POINTER arg1, EIF_POINTER arg2)
{
	...
	/* TEST_EXAMPLE t0 */
EIF_TYPED_VALUE _A984_77 ( EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE), EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5435, "t0", closed [1].it_r))(closed [1].it_r);
}

	/* TEST_EXAMPLE t1 */
EIF_TYPED_VALUE _A984_78 ( EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE), EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5436, "t1", closed [1].it_r))(closed [1].it_r);
}

	/* TEST_EXAMPLE t2 */
EIF_TYPED_VALUE _A984_79 ( EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE), EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5437, "t2", closed [1].it_r))(closed [1].it_r);
}

	/* TEST_EXAMPLE t3 */
EIF_TYPED_VALUE _A984_80 ( EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE), EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5438, "t3", closed [1].it_r))(closed [1].it_r);
}
