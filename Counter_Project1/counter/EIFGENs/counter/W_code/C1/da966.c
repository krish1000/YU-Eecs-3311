...
{
	GTCX
	RTOTC (F966_7276,13599,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 965, Current, 0, 0, 13599);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 965, Current, 0, 0, 13601);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 965, Current, 0, 0, 13602);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
{
	GTCX
	RTOTC (F966_7281,13604,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F966_7282,13605,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F966_7283,13606,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit966 (void)
{
	GTCX
	RTOTS (7276,F966_7276)
	RTOTS (7277,F966_7277)
	RTOTS (7278,F966_7278)
	RTOTS (7279,F966_7279)
	RTOTS (7280,F966_7280)
	RTOTS (7281,F966_7281)
	RTOTS (7282,F966_7282)
	RTOTS (7283,F966_7283)
}
