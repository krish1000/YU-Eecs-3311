...
extern EIF_TYPED_VALUE F974_7406(EIF_REFERENCE);
...
RTOID (F974_7406)
EIF_TYPED_VALUE F974_7406 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 973, Current, 0, 0, 13692);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(973, Current, 13692);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
