...
static const EIF_TYPE_INDEX egt_13_1001 [] = {0xFF01,51,0xFFFF};
...
static const EIF_TYPE_INDEX egt_17_1001 [] = {0xFF01,254,0xFF01,0xFFF9,0,186,0xFFFF};
static const EIF_TYPE_INDEX egt_18_1001 [] = {0xFF01,232,0xFFFF};
...
static const struct desc_info desc_1001[] = {
	...
	{EIF_GENERIC(egt_13_1001), 1317, 0xFFFFFFFF},
	...
	{EIF_NON_GENERIC(0x0197 /*203*/), 14032, 40},
	{EIF_NON_GENERIC(0x0197 /*203*/), 14033, 41},
	{EIF_GENERIC(egt_14_1001), 14034, 0},
	{EIF_GENERIC(egt_15_1001), 14035, 8},
	{EIF_GENERIC(egt_16_1001), 14036, 16},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 14037, 44},
	{EIF_GENERIC(egt_17_1001), 14038, 24},
	{EIF_GENERIC(NULL), 14044, 0xFFFFFFFF},
	{EIF_GENERIC(egt_18_1001), 14047, 32},
};
void Init1001(void)
{
	IDSC(desc_1001, 0, 1000);
	IDSC(desc_1001 + 1, 1, 1000);
	IDSC(desc_1001 + 32, 193, 1000);
	IDSC(desc_1001 + 65, 233, 1000);
	IDSC(desc_1001 + 66, 103, 1000);
	IDSC(desc_1001 + 91, 372, 1000);
	IDSC(desc_1001 + 103, 371, 1000);
}
