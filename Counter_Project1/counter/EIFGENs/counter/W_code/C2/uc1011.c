...
extern EIF_TYPED_VALUE F1011_8040(EIF_REFERENCE);
...
RTOID (F1011_8040)
EIF_TYPED_VALUE F1011_8040 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1010, Current, 0, 0, 14294);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000421, 0,0); /* Result */
