...
extern EIF_TYPED_VALUE F998_7765(EIF_REFERENCE);
...
RTOID (F998_7765)
EIF_TYPED_VALUE F998_7765 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 997, Current, 0, 0, 14029);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 14029);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
