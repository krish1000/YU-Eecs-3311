...
extern EIF_TYPED_VALUE F997_7764(EIF_REFERENCE);
...
RTOID (F997_7764)
EIF_TYPED_VALUE F997_7764 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 996, Current, 0, 0, 14028);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(996, Current, 14028);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
