...
extern EIF_TYPED_VALUE F1022_8142(EIF_REFERENCE);
...
RTOID (F1022_8142)
EIF_TYPED_VALUE F1022_8142 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1021, Current, 0, 0, 14396);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1021, Current, 14396);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
