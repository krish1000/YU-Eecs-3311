...
static const EIF_TYPE_INDEX egt_13_999 [] = {0xFF01,51,0xFFFF};
...
static const EIF_TYPE_INDEX egt_17_999 [] = {0xFF01,254,0xFF01,0xFFF9,0,186,0xFFFF};
...
static const struct desc_info desc_999[] = {
	...
	{EIF_GENERIC(egt_13_999), 1317, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_14_999), 14034, 0},
	{EIF_GENERIC(egt_15_999), 14035, 8},
	{EIF_GENERIC(egt_16_999), 14036, 16},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 14037, 36},
	{EIF_GENERIC(egt_17_999), 14038, 24},
};
void Init999(void)
{
	IDSC(desc_999, 0, 998);
	IDSC(desc_999 + 1, 1, 998);
	IDSC(desc_999 + 32, 193, 998);
	IDSC(desc_999 + 65, 233, 998);
	IDSC(desc_999 + 66, 103, 998);
	IDSC(desc_999 + 91, 372, 998);
}
