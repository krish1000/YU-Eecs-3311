...
extern EIF_TYPED_VALUE F1029_8308(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1029_8310(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1029_8308 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1028, Current, 2, 3, 14586);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1028, Current, 14586);
	RTCC(arg1, 1028, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1029_8310 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_c1
	...
	RTEAA(l_feature_name, 1028, Current, 0, 1, 14587);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1028, Current, 14587);
	RTIV(Current, RTAL);
	RTHOOK(1);
