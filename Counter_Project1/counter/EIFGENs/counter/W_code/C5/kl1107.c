...
extern EIF_TYPED_VALUE F1107_7287(EIF_REFERENCE);
extern void F1107_7288(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1107_7289(EIF_REFERENCE);
...
/* {KL_LINKABLE}.right */
EIF_TYPED_VALUE F1107_7287 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1107_7288 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1106, Current, 0, 1, 13610);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1106, Current, 13610);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 5074, 0xF8000452, 0); /* right */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
void F1107_7289 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1106, Current, 0, 0, 13611);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1106, Current, 13611);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5074, 0xF8000452, 0); /* right */
