...
extern EIF_TYPED_VALUE F1068_8635(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1068_8636(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1068_8637(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1068_8638(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1068_8640(EIF_REFERENCE);
extern void F1068_8641(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1068_8635 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1067, Current, 2, 0, 14903);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1067, Current, 14903);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = '\0';
...
EIF_TYPED_VALUE F1068_8636 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1067, Current, 1, 2, 14904);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1067, Current, 14904);
	RTCC(arg1, 1067, l_feature_name, 1, RTWCT(6226, dtype, dftype), 0x00);
	RTCC(arg2, 1067, l_feature_name, 2, RTWCT(6226, dtype, dftype), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1068_8637 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1067, Current, 0, 1, 14905);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1067, Current, 14905);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,1067,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
		...
		RTCC(arg1, 1067, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1068_8638 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1067, Current, 0, 1, 14906);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1067, Current, 14906);
	RTCC(arg1, 1067, l_feature_name, 1, RTWCT(6271, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
EIF_TYPED_VALUE F1068_8640 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1068_8641 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1067, Current, 0, 1, 14908);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1067, Current, 14908);
	RTCC(arg1, 1067, l_feature_name, 1, RTWCT(6271, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6271, 0xF8000429, 0); /* equality_tester */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
