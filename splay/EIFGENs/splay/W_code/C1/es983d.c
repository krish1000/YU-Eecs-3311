...
static const struct desc_info desc_983[] = {
	...
	{EIF_NON_GENERIC(0x0197 /*203*/), 13796, 32},
	{EIF_NON_GENERIC(0x0197 /*203*/), 13797, 33},
	{EIF_GENERIC(egt_14_983), 13798, 0},
	{EIF_GENERIC(egt_15_983), 13799, 8},
	{EIF_GENERIC(egt_16_983), 13800, 16},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 13801, 36},
	{EIF_GENERIC(egt_17_983), 13812, 24},
};
void Init983(void)
{
	IDSC(desc_983, 0, 982);
