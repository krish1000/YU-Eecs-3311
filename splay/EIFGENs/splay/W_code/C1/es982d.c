...
static const struct desc_info desc_982[] = {
	...
	{EIF_NON_GENERIC(0x0197 /*203*/), 13796, 40},
	{EIF_NON_GENERIC(0x0197 /*203*/), 13797, 41},
	{EIF_GENERIC(egt_14_982), 13798, 0},
	{EIF_GENERIC(egt_15_982), 13799, 8},
	{EIF_GENERIC(egt_16_982), 13800, 16},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 13801, 44},
	{EIF_GENERIC(egt_17_982), 13802, 24},
	{EIF_GENERIC(NULL), 13805, 0xFFFFFFFF},
	{EIF_GENERIC(egt_18_982), 13808, 32},
};
void Init982(void)
{
	IDSC(desc_982, 0, 981);
