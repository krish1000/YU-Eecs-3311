...
extern EIF_TYPED_VALUE F979_7519(EIF_REFERENCE);
extern EIF_TYPED_VALUE F979_7520(EIF_REFERENCE);
extern EIF_TYPED_VALUE F979_7521(EIF_REFERENCE);
...
EIF_TYPED_VALUE F979_7519 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F979_7520 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(5282,Dtype(Current)));
	return r;
}


/* {DATE_TIME_VALUE}.fractional_second */
EIF_TYPED_VALUE F979_7521 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 978, Current, 0, 0, 13794);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(978, Current, 13794);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(5248, "fractional_second", tr1));
