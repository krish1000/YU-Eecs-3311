note
	description: "Summary description for {BIRTHDAY_BOOK_VIOLATING_CELEBRATE2}."
	author: ""
	date: "$Date$"
	revision: "$Revision$"

class
	BIRTHDAY_BOOK_VIOLATING_CELEBRATE2
...
feature -- command
	...
	--			Result.compare_objects -- don't really need this as we add the reference objects (strings) into the Result array
			...
			until
				i > birthdays.count
			loop
				if birthdays[i] /~ today then --wrong implementation
